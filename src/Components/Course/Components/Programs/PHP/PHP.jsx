                    ...
                    <div className="container p-5">
                        <div className="row p-5">
                            <div className="col text-white text-center bg-info px-5 mx-5 rounded-4 bg-opacity-10">
                                ...
                                <h1 className='p-5 pt-3 mb-5'><b>PHP</b></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container p-4">
                    <div className="row align-items-center justify-content-center">
                        <div className="col-7 p-5 pb-3 text-center">
                            ...
                            <p className='fs-2 fw-semibold p-2'>PHP</p>
                        </div>
                        <div className="col-7">
                            <p className="fs-4 fw-medium">Overview</p>
                            <p className="fs-6 text-secondary">let's learn a little more about what you can do whit php.</p>
                        </div>
